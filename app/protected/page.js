            ...
            <section className="relative mx-auto max-w-6xl px-5 py-8 sm:px-8">
                ...
                <div className="rounded-[2rem] border border-emerald-400/20 bg-gradient-to-br from-emerald-400/10 via-black to-emerald-900/20 p-6 shadow-[0_0_80px_rgba(16,185,129,0.12)] sm:p-8">
                    ...
                    <p className="mt-5 max-w-3xl text-base leading-8 text-white/65">
                        Trust The Signal is moving beyond public contract tools into a protected
                        member ecosystem built for operator alerts, scanner upgrades, private
                        notes, gated dashboards, and premium intelligence continuation.
                    </p>
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p className="mt-2 text-sm leading-7 text-white/65">
                                Future Telegram verification, Discord role access, private member
                                dashboards, scanner premium feeds, and gated downloads can all
                                route through this protected ecosystem layer.
                            </p>
                        </div>
                    </div>
                </div>
